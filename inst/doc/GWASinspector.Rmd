...
This vignette introduces the GWASinspector package, its general form and how to run the algorithm on multiple GWAS result files. Check our [website](https://GWASinspector.com) for further information and reference data sets. 

The manual for this package can also be accessed online from [here](https://gwasinspector.com/references/Introduction_to_GWASinspector.pdf).
...
We have created databases from the most popular refernece panel (e.g. HapMap, 1000G, HRC) which are available from our [website](https://GWASinspector.com). Database files are in SQLite format and can be downloaded as a compressed file. 
...
Standard allele-frequency reference datasets are available from our [website](https://GWASinspector.com). The database file should be decompressed and copied in the *references* folder [`dir_references` parameter of the config file].
