...
Duplicated lines:  **`r format(.QC$thisStudy$dup_lines_count, big.mark = ',' ,scientific = FALSE)`**
...
`r b <- t(data.frame('CHR' = c(abs(study$column.NA.list$CHR - study$column.INVALID.list$CHR) ,
                    ...
                    'POSITION' = c(abs(study$column.NA.list$POSITION - study$column.INVALID.list$POSITION) ,
                                   paste(study$column.INVALID.list$POSITION, kableExtra::footnote_marker_symbol(1)),
                                   ' '),
                    ...
                    'EFFECT' = c(abs(study$column.NA.list$EFFECT - study$column.INVALID.list$EFFECT) ,
                                 paste(study$column.INVALID.list$EFFECT,kableExtra::footnote_marker_symbol(3)),
                                 ' '),
...
`r count.table <- t(data.table(
  ...
  rownames(count.table)[3] <- sprintf("<span class='mainItem'>Variant count after step 1 %s</span>",kableExtra::footnote_marker_symbol(1))
...
count.table2 <- t(data.table(
  ...
  kable(count.table,escape='FALSE', align = "l",format = "html") %>% 
	...
	kableExtra::footnote(general = ' ', symbol = c( 
                      "step1: removing variants with missing crucial values.",
                      "step2: removing monomorphic, duplicated and chromosomal variants.",
...
`r  count.table1 <- t(data.table(
    "<span class='mainItem'>Found variants</span>" = calculatePercent(.QC$thisStudy$found.rows.std,
    ...
    "<span class='mainItem'>Not-found variants</span>" = calculatePercent(.QC$thisStudy$not.found.rows.std,
                                            ...
                                            decimal.place=3,
                                            pretty=TRUE),
    "<span class='mainItem'>Mismatch variants</span>" = calculatePercent(.QC$thisStudy$mismatched.rows.std,
                                           .QC$thisStudy$found.rows.std,
                                           decimal.place=3,
                                           pretty=TRUE),
    "<span class='mainItem'>Non-verified multiallelic variants</span>" = calculatePercent(.QC$thisStudy$multiAlleleVariants.rowcount,
                                           .QC$thisStudy$found.rows.std,
                                           decimal.place=3,
                                           pretty=TRUE),
    "<span class='mainItem'>Ambiguous variants</span>" = calculatePercent(.QC$thisStudy$ambiguos.rows,
                                           .QC$thisStudy$found.rows.std,
                                           decimal.place=3,
                                           pretty=TRUE),
...
`r if(!is.na(.QC$config$supplementaryFiles$allele_ref_alt)){
 ...
 count.table2 <- t(data.table(
      "<span class='mainItem'>Found variants</span>" = calculatePercent(.QC$thisStudy$found.rows.alt ,
      ...
      "<span class='mainItem'>Not-found variants</span>" = calculatePercent(.QC$thisStudy$not.found.rows.alt ,
                                              ...
                                              decimal.place=3,
                                              pretty=TRUE),
      "<span class='mainItem'>Mismatch variants</span>" = calculatePercent(.QC$thisStudy$mismatched.rows.alt ,
...
<h3 class="header1">Summary statistics</h3>
...
<h4 class="header2">Effect allele distribution</h4>
`r 
...
<h4 class="header2">Other allele distribution</h4>
`r 
